...
const PatientInformation = () => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-6 space-y-4">
            <h2 className="font-medium text-xl text-blue-700">Search Patient Information</h2>
            ...
            {patientInfo && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg shadow">
                    <h3 className="text-lg font-bold text-blue-700 mb-2">Patient Information:</h3>
                    <p><strong>Name:</strong> {patientInfo.name}</p>
                    <p><strong>Student ID:</strong> {patientInfo.studentId}</p>
                    <p><strong>Phone:</strong> {patientInfo.phone}</p>
                    <p><strong>Address:</strong> {patientInfo.address}</p>
                    <p><strong>Major:</strong> {patientInfo.major}</p>
                </div>
            )}
        </div>
    );
